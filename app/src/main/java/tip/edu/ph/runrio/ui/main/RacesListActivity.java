...
import tip.edu.ph.runrio.databinding.ActivityMainBinding;
...
public class RacesListActivity
        extends MvpViewStateActivity<RacesListView, RacesListPresenter>
        implements SwipeRefreshLayout.OnRefreshListener , NavigationView.OnNavigationItemSelectedListener, RacesListView{
  ...
  /*  private void prepareList() {
    ...
    @NonNull
    @Override
    public RacesListPresenter createPresenter() {
        return new RacesListPresenter();
    }
    ...
    @NonNull
    @Override
    public ViewState<RacesListView> createViewState() {
        setRetainInstance(true);
        return new RacesListViewState();
    }
